...
export class UserService {
  ...
  users : IUser[] = [
    ...
    { id: 6, name: 'Jessica', species: 'ugly fish', 
    email:'jessyXoXo@gmail.com', country: 'Australia', city: 'Sidney', 
    isLoggedIn: false, password: 'beauty_full.100',
    profilePic: '../assets/images/jessica.jpg',
    friends: [0,1,2,3,4,5]},
  ];
